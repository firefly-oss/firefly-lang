#!/usr/bin/env bash
# Firefly Language Uninstaller
set -euo pipefail

PREFIX="${1:-/usr/local}"
INSTALL_BIN="${PREFIX}/bin"
INSTALL_LIB="${PREFIX}/lib/firefly"
LAUNCHER="${INSTALL_BIN}/firefly"
...
bold "Uninstalling Firefly Language"
...
success "Firefly uninstalled successfully"
info "To reinstall: curl -fsSL https://raw.githubusercontent.com/firefly-oss/firefly-lang/main/install.sh | bash"
